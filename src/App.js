...
function App() {
  return (
    <>
      {/* ================  Hero ================ */}
      <Header />
      <div className="flex flex-col md:flex-row gap-3 md:gap-6 mx-auto max-w-xs md:max-w-md mt-4">
        {/* ================ Download Buttons =================== */}
        <Button
          btnText="Download For IOS"
          btnClasses="bg-green-700 text-white px-6 py-2"
        />
        <Button
          btnText="Download For MAC"
          btnClasses="bg-blue-700 text-white px-6 py-2"
        />
      </div>
      ...
      <div className="max-w-xl space-y-5 mt-4 p-4 mx-auto">
        ...
        <Section
          ...
          headingClasses="text-center font-bold text-2xl tracking-wider "
          paragraphClasses="text-center"
          paragraphText="Note that the development build is not optimized.To create a production build .Note that the development build  evelopment build is not optimized.To create a production build"
        />
      </div>
      ...
      <div className="flex flex-col lg:flex-row mt-14 ">
        <div className="max-w-3xl mx-auto p-4">
          <img src="https://images.pexels.com/photos/1229861/pexels-photo-1229861.jpeg?auto=compress&cs=tinysrgb&w=600" className="rounded-lg w-full h-full object-contain" />
        </div>
      ...
      />
      <div className="flex flex-col md:flex-row mx-auto gap-3 md:gap-5 w-2/3 p-4">
      ...
      <div className="flex flex-col gap-2 p-4 justify-center items-center md:flex-row md:justify-around md:gap-0">
        <div className="flex md:items-center md:justify-center max-w-xs">
          <p className="text-slate-300 text-2xl font-bold md:text-4xl">Google</p>
        </div>
